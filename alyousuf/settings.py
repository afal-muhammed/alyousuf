"""
Django settings for alyousuf project.
...
SECRET_KEY = 'django-insecure-g@h3k^^+umbmeyx03oy6j8au@s4w&ae!u_e%@*^#d20qp^a=wy'
...
WSGI_APPLICATION = 'alyousuf.wsgi.application'
